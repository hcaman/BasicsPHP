...
<html>
  ...
  <body>
    <div class="contenedor">
      ...
      <?php
          // validar inputs
          if(! (filter_has_var(INPUT_POST, 'nombre') && //SIRVE PARA VALIDAR RESULTADOS
      ...
      <p>Nombre: <?php echo $nombre; ?></p>
          ...
          <?php if(!isset($apellido) || trim($apellido) != '') { //OTRA FORMA DE VALIDAR - TRIM VALIDA ESPACIOS EN BLANCO ?>
      ...
      <?php
       ...
       <?php if(isset($_POST['mensaje'])) {
         ...
         $nuevo_mensaje = filter_var($mensaje, FILTER_SANITIZE_STRING); // ESTO ES PARA LA SEGURIDAD DEL SITIO PORQUE SINO SE PUEDEN METER CODIGOS JS Y MODIFICAR TU SITIO
